...
<meta charset="utf-8">
<title>欢迎老师，您！</title>
<link href="css/teacherLogIn.css" type="text/css" rel="stylesheet">
...
<body>
	...
	<form action="LogIn" method="post" name="form1" id="form1" onsubmit="reg(this);">
		...
		<input type="text" name="userName" id="userName" placeholder="输入教师ID">
	...
	<form action="ForgetPWD" method="post" name="form2" id="form2">
